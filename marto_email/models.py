...
class EmailMessage(models.Model):
    ...
    send_successful = models.BooleanField(default=False, db_index=True)
    ...
    email_dump_binary = models.BinaryField(null=True, blank=True)  # Storing alternatives and attachments here
